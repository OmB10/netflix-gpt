            ...
            <div className="relative w-full">
                ...
                <div className="relative flex flex-col text-center text-white pt-16 md:pt-32 justify-center items-center px-4">
                    ...
                    <div className="flex flex-col md:flex-row items-center">
                        <input className="mr-0 md:mr-4 p-2 border border-green-300 text-black rounded-sm mb-4 md:mb-0" type="email" placeholder="Email Address" />
                        <button className="bg-red-600 text-white p-2 rounded-sm" onClick={() => navigate("/login")}>Get Started</button>
                    </div>
                </div>
            </div>
            <div className='bg-black z-20 relative mt-24 md:mt-44'>
                <Features />
                <Footer />
            </div>
        </div>
