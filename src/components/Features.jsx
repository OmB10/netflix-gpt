...
const Features = () => {
    return (
        <div className='w-full md:w-3/4 lg:w-10/12 mx-auto'>
            <div className='flex flex-col md:flex-row justify-center text-white'>
                <div className='flex flex-col items-start justify-center mb-4 md:mb-0'>
                    <h2 className="text-2xl md:text-4xl mb-4 font-bold">Enjoy on your TV.</h2>
                    <p className="text-sm md:text-xl">Watch on smart TVs, PlayStation, Xbox, Chromecast, Apple TV, Blu-ray players and more.</p>
                </div>
                <div className='relative w-full md:w-1/2 h-64 md:h-96 lg:h-80 xl:h-96'>
            ...
            {/* second */}
            <div className='flex flex-col-reverse md:flex-row justify-center text-white'>
                <div className='relative w-full md:w-1/2 h-64 md:h-96 lg:h-80 xl:h-96'>
                ...
                <div className='flex flex-col items-start justify-center mt-4 md:mt-0'>
                    <h2 className="text-2xl md:text-4xl mb-4">Download your shows to watch offline</h2>
                    <p className="text-sm md:text-xl">Save your favourites easily and always have something to watch.</p>
                </div>
            </div>
            {/* third */}
            <div className='flex flex-col md:flex-row justify-center text-white'>
                <div className='flex flex-col items-start justify-center mb-4 md:mb-0'>
                    <h2 className="text-2xl md:text-4xl mb-4">Watch everywhere</h2>
                    <p className="text-sm md:text-xl">Stream unlimited movies and TV shows on your phone, tablet, laptop, and TV.</p>
                </div>
                <div className='relative w-full md:w-1/2 h-64 md:h-96 lg:h-80 xl:h-96'>
            ...
            <div className='flex flex-col-reverse md:flex-row justify-center text-white'>
                ...
                <div className='flex flex-col items-start justify-center mt-4 md:mt-0'>
                    <h2 className="text-2xl md:text-4xl mb-4">Create profiles for kids</h2>
                    <p className="text-sm md:text-xl">Send children on adventures with their favourite characters in a space made just for them—free with your membership.</p>
                </div>
            </div>
            <FAQ />
        </div>
